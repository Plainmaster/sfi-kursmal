...
**Domain:** Static educational website / SFI learning tools
**Researched:** 2026-04-10
**Confidence:** HIGH (core choices), MEDIUM (icon library)
...
npm create astro@latest sfi-spaar2 -- --template minimal --typescript strict
